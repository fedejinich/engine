...
const {HIT, MISS, CRIT, NO_CRIT, MIN_DMG, MAX_DMG, TIE} = ROLLS.basic({
  hit: 'data/mods/gen1/scripts.ts:434:42',
  crit: 'data/mods/gen1/scripts.ts:833:27',
  dmg: 'data/mods/gen1/scripts.ts:954:27',
});

const SECONDARY = (value: number) => ({key: 'data/mods/gen1/scripts.ts:722:25', value});
const SLP = (n: number) =>
...
const REWRAP = {key: 'data/mods/gen1/scripts.ts:248:38', value: MIN};
...
describe('Gen 1', () => {
  ...
  test('MultiHit effect', () => {
    const hit3 = {key: 'data/mods/gen1/scripts.ts:449:27', value: 0x60000000};
  ...
  test('Counter effect', () => {
    const hit2 = {key: 'data/mods/gen1/scripts.ts:449:27', value: MIN};
    const battle = startBattle([
